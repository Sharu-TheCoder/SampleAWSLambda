package com.emilie.serverless.patient.domain.response;
...
public class ApiGatewayResponse {
    ...
    public ApiGatewayResponse(final int statusCode,
                              final String body,
    ...
    public static class Builder {
        ...
        public ApiGatewayResponse build() {
            ...
            if (rawBody != null) {
                ...
                try {
                    body = DefaultMapper.objectMapper.writeValueAsString(objectBody);
